...
public class CommonConstants {
	...
	public static final String TUTORIAL_ID_PREFIX = "E300";
	...
	public static final String QUERY_ID_CREATE_TABLE = "create_tutorials_table";

	/** Constant for query id of insert employees in EmployeeQuery.xml */
	public static final String QUERY_ID_INSERT_TUTORIAL = "insert_tutorial";

	/** Constant for query id of get an employee in EmployeeQuery.xml */
	public static final String QUERY_ID_GET_TUTORIAL = "tutorial_by_id";

	/** Constant for query id of get all employees in EmployeeQuery.xml */
	public static final String QUERY_ID_ALL_TUTORIALS = "all_tutorials";

	/** Constant for query id of remove a employee in EmployeeQuery.xml */
	public static final String QUERY_ID_REMOVE_TUTORIAL = "remove_tutorial";

	/** Constant for query id of update a employee in EmployeeQuery.xml */
	public static final String QUERY_ID_UPDATE_TUTORIAL = "update_tutorial";

	/** Constant for query id of get all employee ids in EmployeeQuery.xml */
	public static final String QUERY_ID_GET_TUTORIAL_IDS = "tutorial_ids";
