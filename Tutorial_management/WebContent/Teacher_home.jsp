...
<button class="tablink" onclick="openPage('Home', this, '#009933')" id="defaultOpen">Classes</button>
...
<div id="Home" class="tabcontent">
		<div class="jumbotron text-center"style="height: 100px; padding: 10px 20px 50px 20px; color:#006622;">
	 		<h2><b>Classes</b></h2>
		</div>
