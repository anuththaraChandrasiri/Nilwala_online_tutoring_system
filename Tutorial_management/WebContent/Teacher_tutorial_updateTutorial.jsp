...
<%@ include file="WEB-INF/Teacher_header.jsp" %>  
		...
		<div class="jumbotron text-center" style="height: 150px;">
	 		 <p style= font-size:50px;>Tute 01 - Lesson 01</p>
		</div>
				   		...
				   		<div class="container">
							  <form action="/action_page.php">
							    <div class="row">
							      ...
							      <div class="col-75">
							        <input type="text" id="fname" name="firstname" placeholder="Name of the tutorial">
							      </div>
							    </div>
							    <div class="row">
							      <div class="col-25">
							    ...
							    <div class="row">
							      ...
							      <div class="col-75">
							        <input type="text" id="fname" name="firstname" placeholder="Month">
							      </div>
							    </div>
							     <div class="row">
							      <div class="col-25">
							    ...
							    <div class="row">
							      <div class="col-25">
							        <label for="subject">Updating date</label>
							      </div>
							      <div class="col-75">
